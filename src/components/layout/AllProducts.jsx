        ...
        {allItems.map((item, index) => {
          return (
            <div className="allProducts__list__details" key={index}>
              <div className="allProducts__list__details__picture">
                <img src={item.img} alt={item.name} />
              </div>
              <div className="allProducts__list__details__brand">
                {item.brand !== "" ? <img src={item.brand} alt="marque" /> : ""}
              </div>
              <div className="allProducts__list__details__name">
                <p>{item.name}</p>
              </div>
              <div className="allProducts__list__details__price">
                {item.price} € HT
              </div>
            </div>
          );
